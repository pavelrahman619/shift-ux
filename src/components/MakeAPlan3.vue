<template>
  <div class="white">
          ...
          <v-form>
            <v-row>
              <v-col cols="6">
                ...
                <v-card-actions>
                  <v-col cols="12" lg="2">
                    <v-btn class="pink white--text">Save</v-btn>
                  </v-col>
                </v-card-actions>
              </v-col>
    ...
    <v-container fluid fill-height1>
      ...
      <br />
      <v-row>
        <p class="font-weight-bold">Related videos:</p>
        <p class="pink--text">Sample title 1, Sample title 2, Sample title 3</p>
      </v-row>
      <br />
      <br />
      ...
      <v-row cols="12" justify="center">
        <v-card width="1000" height="500" class="d-flex flex-column">
          ...
          <v-card-text>
            <v-text-field
              label="What do you want to achieve at the end of the campaign?"
              required
            >
            </v-text-field>
          </v-card-text>
